                    ...
                    <div className="flex items-center justify-between md:justify-start">
                        ...
                        <div className="hidden md:block ml-2 lg:ml-5 xl:ml-10">
                            <div className="flex items-center md:gap-8 lg:gap-12 xl:gap-16">
                                ...
                                <Link to="categorias" className="navLink text-sm lg:text-base">Categorias</Link>
                                <Link to="categorias/novo" className="navLink text-sm lg:text-base">Nova Categoria</Link>
                ...
                {menuOpen && (
                    <div className="md:hidden">
                        <div className="flex flex-col gap-4 px-2 pt-2 pb-3 sm:px-3">
                            ...
                            <Link to="admin" className="navLinkMobile">Novo Produto</Link>
                            <Link to="admin" className="navLinkMobile">Categorias</Link>
                            <Link to="admin" className="navLinkMobile">Nova Categoria</Link>
                            <Link to="admin" className="navLinkMobile">Restaurantes</Link>
                            <Link to="admin" className="navLinkMobile">Novo Restaurante</Link>
                        </div>
                    </div>
                )}
            </nav>
