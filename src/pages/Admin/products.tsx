    ...
    <div className="max-w-screen-xl mx-auto paddingPage space-y-6 h-screen">
      <div className="my-6 space-y-6">
        <div className="w-full flex flex-col justify-center md:flex-row md:justify-between gap-4">
          <Title className="text-center md:text-start">Produtos</Title>
          <Search />
        </div>
        <div className="flex justify-between items-center gap-y-3 flex-wrap">
          ...
          <LinkButton to="/admin/novo" className="bg-green-600 text-white md:text-sm">
          ...
          <tbody>
            {Array.from({ length: 10 }).map((_, index) => (
              <TableRow key={index + 1}>
                <TableCell>Filé mignon com fritas e arroz a piemontese com molho madeira</TableCell>
